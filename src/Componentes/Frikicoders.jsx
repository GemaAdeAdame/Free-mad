    ...
    <div class="completo">
      ...
      <div class="container_l">
          ...
          <div class="evenIm"><img class="card_img" src={cerebralCul} alt='Imagen evento Metaverso'/>
            ...
            <a href="https://www.lanavemadrid.com/actividad/meta-world-congress-2023/" target="_blank"><button class="boton bg-red-500 hover:bg-red-400 text-white font-bold py-4 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">
            + INFO</button></a>
          ...
          <div class="evento2_l">
            ...
            <div class="evenIm"><img class="card_img" src={femenino} alt='Imagen evento Innovando en femenino'/></div>
              ...
              <div class="card_texts letra_l">
                ...
                <a href="https://www.eventbrite.es/e/entradas-innovando-en-femenino-mujeres-en-montegancedo-519661570747" target="_blank"><button class="boton bg-purple-500 hover:bg-purple-400 text-white font-bold py-2 px-4 border-b-4 border-purple-700 hover:border-blue-500 rounded">+ INFO</button></a>
            ...
            <div class="evento3_l">
              ...
              <p class="card_paragraph letra_l" >React.JS es la librería de frontend más extendida para la creación de SPA (Single Page Applications, páginas web sin cargas).En esta clase verás como crear una pequeña aplicación con React desde cero.</p>
                ...
                <a href="https://www.eventbrite.com/e/entradas-clase-introduccion-a-reactjs-519910405017" target="_blank"><button class="boton bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 border-b-4 border-blue-800 hover:border-blue-500 rounded">+ INFO</button></a>
            ...
            <div class="evento4_l">
              ...
              <div class="card_texts letra_l">
                ...
                <a href="https://www.eventbrite.es/e/entradas-t3chfest-2023-515596953367?aff=ebdssbcategorybrowse" target="_blank"><button class="boton bg-orange-500 hover:bg-green-300 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-orange-500 rounded">+ INFO</button></a>
